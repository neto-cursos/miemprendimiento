        ...
        @include('admin.layouts.messages.notifications')
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Actualizar Fuentefinan</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('fuentefinans.update', $fuentefinan->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
