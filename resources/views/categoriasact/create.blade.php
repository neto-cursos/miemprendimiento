        ...
        @include('admin.layouts.messages.notifications')
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Crear Categoriasact</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('categoriasacts.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
